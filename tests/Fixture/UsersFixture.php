...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'login_count' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'last_connexion' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        ...
        'ville' => ['type' => 'string', 'length' => 150, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'date_recrut' => ['type' => 'date', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'client_id' => 1,
                'login_count' => 1,
                'last_connexion' => '2019-01-10 14:03:07',
                'active' => 1,
                'imageUri' => 'Lorem ipsum dolor sit amet',
                'ville' => 'Lorem ipsum dolor sit amet',
                'nation_id' => 1,
                'sector_id' => 1,
                'created' => '2019-01-10 14:03:07',
                'date_recrut' => '2019-01-10'
            ],
        ];
        parent::init();
    }
